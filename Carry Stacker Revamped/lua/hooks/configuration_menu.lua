...
Hooks:Add("MenuManagerInitialize", 
	...
	function(menu_manager)
		...
		MenuCallbackHandler.BLT_CarryStacker_Reset = function(this, item)
			local logger = BLT_CarryStacker.Log
			logger("The player requested resetting settings to their default")
			...
			MenuHelper:ResetItemsToDefaultValue(item, {bltcs_toggle_penalties = true},
				BLT_CarryStacker.settings.toggle_penalties)
		end
		...
		MenuCallbackHandler.BLT_CarryStacker_togglePenalties = function(this, item)
			local logger = BLT_CarryStacker.Log
			logger("The player wants to change the value of toggle_penalties")
			BLT_CarryStacker:SetSetting("toggle_penalties", val2bool(item:value()))
		end
		...
		MenuHelper:LoadFromJsonFile(BLT_CarryStacker._path .. "menu/options.txt", 
			BLT_CarryStacker, (function()
				...
				tbl.toggle_penalties = BLT_CarryStacker.settings.toggle_penalties
				return tbl
